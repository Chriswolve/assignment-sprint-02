...
def preprocess_data(
    ...
    """
    Pre-processes data for modeling with guaranteed 246 features output.
    Includes SMOTE oversampling for handling class imbalance.
    ...
    Returns:
        train: np.ndarray with shape (balanced_samples, 246)
        val: np.ndarray with shape (49202, 246)
        test: np.ndarray with shape (61503, 246)
    """
